// DrawByPrintfAndClscr.cpp : Defines the entry point for the console application.
//

/*
	>Description: Console drawing test using printf and clear screen (system("cls"))
	>Summary:
		Flicking: frequently
		Speed   : Very slow
	>Note:	- Resize console to maximum
			- turn-of unikey			
*/
...
void refresh(void)
{
	/* Move cursor back first position by clear console */
	system("cls");
